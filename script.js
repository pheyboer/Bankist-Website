...
tabsContainer.addEventListener('click', function (e) {
  ...
  //Ignore areas inbetween buttons - guard clause
  if (!clicked) return;
...
// Implement Sticky Navigation: intersection observer API
...
const imgObserver = new IntersectionObserver(loadImg, {
  root: null,
  threshold: 0,
  rootMargin: '200px', //picture loads 200px before we reach it
});
